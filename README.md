Tubecast is a web app that is meant to recreate the classic Comcast TV Guide Channel and OnDemand Screen experience.  The user lands on the TV Guide screen to see an autoscrolling list of channels.
